...
\textbf{RQ1:} What are the most efficient and effective solutions to Company X's VRP variant, considering its unique constraints and objectives?
...
\begin{landscape}
  ...
  \begin{tabular}{ l c c c c c c c c }
    ...
    \cite{surname2005placeholder} & \checkmark &  & \checkmark &  & a\tnote{a} & \checkmark & \checkmark & 51,000 \\
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includesvg[width=0.95\linewidth]{figures/pfit-example-paper-sav-in.svg}
        \caption{Subfigure A}
        \label{fig:subfiga}
    \end{subfigure}%
    \hfill
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includesvg[width=0.95\linewidth]{figures/pfit-example-paper-sav-out.svg}
        \caption{Subfigure B}
        \label{fig:subfigb}
    \end{subfigure}
